<div class="hero-container">
  <div class="hero-text-side">
    <div class="hero-tag">Sistemas Operativos</div>
    <h1 class="hero-title">Explora, Gestiona y Ejecuta Kernel & Procesos</h1>
    <p class="hero-description">Plataforma interactiva para la gestión de laboratorios prácticos, hilos y programación de memoria.</p>
    <details class="lab-dropdown">
      <summary>Seleccionar Laboratorio Disponible <span class="chevron">▾</span></summary>
      <ul class="lab-list">
  ...
  <div class="hero-image-card">
    <img src="img/SO.jpg" alt="Ubuntu Kernel y Procesos">
    <div class="hero-terminal">
      <div class="line"><span class="prompt">ubuntu:~$</span> echo "By Univ. Jhonn Orellana Fernandez" &gt; autor.txt<span class="cursor"></span></div>
    </div>
  </div>
</div>